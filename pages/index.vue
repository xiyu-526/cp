  ...
  <div class="swiper mySwiper">
    <div class="swiper-wrapper">
        <div class="swiper-slide slidebg c1">
          <div class="bgcom bg1" :style="{'background-image':`url(${item.game_index_image_pc})`}" :class="{cur:linkIndex===index}" v-for="(item,index) in list">
            <div class="content">
...
<script setup>
  ...
  onMounted(() => {
    let mouseX = 0, mouseY = 0 ,x = 0, y = 0, z = 0, s = 1,
    ...
    nextTick(()=>{
      ...
      document.querySelector('.about').addEventListener( 'mousemove', onDocumentMouseMove, false );
